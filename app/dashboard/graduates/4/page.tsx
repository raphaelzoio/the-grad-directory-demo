...
const relatedProfiles = [
  { id: 1, name: "Sarah Nowak", university: "Oxford", degree: "Computer Science, BSc", classification: "First", avatar: "SJ" },
              ...
              {beyondCvExpanded && (
                <div className="mt-4 space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    In his Abstract Box, David answered the question &ldquo;If you had £10,000 and six months, what would you create or explore?&rdquo;.{" "}
